...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, self_attention: MultiHeadAttentionBlock, cross_attention_block: MultiHeadAttentionBlock, feed_forward_block: FeedForwardBlock, dropout: float) -> None:
        super().__init__()
...
def build_transformer(src_vocab_size: int, tgt_vocab_size: int, src_seq_len: int, tgt_seq_len: int,     
    ...
    # create transformer
    transformer = Transformer(decoder, encoder, src_embed, tgt_embed, src_pos, tgt_pos, projection_layer)
